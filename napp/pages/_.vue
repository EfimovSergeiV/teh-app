        ...
        <transition name="fade">
          <div v-if="showCreateProject" id="create-project" class="fixed z-10 my-2">
            <div class="bg-sky-900 w-[600px] px-4 py-4 rounded-lg shadow-lg shadow-gray-900">
              ...
              <div class="flex items-center justify-end">
                <div class="mt-4">
                  <button id="file" class="px-6 py-2 bg-white disabled:bg-gray-400 rounded-full text-sm font-semibold text-sky-900 transition-all duration-700" @click="createProject">Создать</button>
                </div>
              </div>
